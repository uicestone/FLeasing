	<section id="headlines">
		<div class="wrapper">
			...
			<div class="widget column-3-1 news">
				<h2><a href="/tag/法律快递/" target="_blank">法律快递</a></h2>
				<hr />
				<?query_posts(array('tag'=>'法律快递','post_per_page'=>1));?>
				<?the_post();?>
				...
				<button class="read-more" onclick="window.location.href='/tag/法律快递/'"></button>
			</div>
		</div>
	</section>
